...
class Config_Generative_Model:
    def __init__(self):
        ...
        self.pretrain_mbm_path = "/home/vision/work/Lcs/mind-vis/results/fmri_pretrain/18-07-2023-20-36-03/checkpoints/checkpoint.pth"
        self.img_size = 256

        np.random.seed(self.seed)
        # finetune parameters
        self.batch_size = 3 if self.dataset == 'GOD' else 25 #5
        self.lr = 5.3e-5
        self.num_epoch = 500
        ...
        self.num_samples = 3 #5
        self.ddim_steps = 250
        self.HW = None
        # resume check util
        self.model_meta = None
        self.checkpoint_path = os.path.join(self.root_path, 'results/generation/06-08-2023-22-49-06/checkpoint_best.pth')
