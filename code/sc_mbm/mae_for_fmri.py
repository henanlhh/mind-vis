...
class MAEforFMRI(nn.Module):
    ...
    """
    def __init__(self, num_voxels=440, patch_size=16, embed_dim=1024, in_chans=1,
    ...
    def patchify(self, imgs):
        ...
        h = imgs.shape[2] // p
        x = imgs.reshape(shape=(imgs.shape[0], h, p*c))
        return x
...
class fmri_encoder(nn.Module):
    def __init__(self, num_voxels=224, patch_size=16, embed_dim=1024, in_chans=128,
